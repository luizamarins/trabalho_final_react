  ...
  function selectedContent() {
    switch (selected) {
      case "Sobre":
        return (
          <h1>
            Somos uma livraria online que leva o conhecimento até a palma de
            suas mãos!
          </h1>
        );
      case "Missão":
        return (
          <h1>
            Promover o conhecimento para todos de maneira dinâmica e eficiente
            :)
          </h1>
        );
      case "Contato":
  ...
  return (
    <>
      ...
      <Container>
        ...
        <img
          src={require("../../assets/img/logo-livros.gif")}
          alt="foto-livros"
        />
      </Container>
